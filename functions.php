...
function custom_header_inline_logo( $title, $inside, $wrap ) {
	...
	$logo = '<img src="' . get_stylesheet_directory_uri() . '/images/MTAH-compact-logo.png" alt="' . esc_attr( get_bloginfo( 'name' ) ) . '" title="' . esc_attr( get_bloginfo( 'name' ) ) . '" width="300" height="77" />';
